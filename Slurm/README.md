This is the directory for **Slurm scripts for running the Bio_ClinicalBERT training, fine-tuning, prediction, and hyperparameter search jobs on the WSU HPC cluster and the Ingham system.**
